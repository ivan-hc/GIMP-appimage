...
mv ./*AppImage ./"$(cat ./$APP.AppDir/*.desktop | grep 'Name=' | head -1 | cut -c 6- | sed 's/ /-/g')"_"$VERSION"-Hybrid-1.0-with-python2-from-Debian-Buster-type3-archimage3.2-x86_64.AppImage
