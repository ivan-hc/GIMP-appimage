...
DEPENDENCES="aalib appstream ffmpeg dbus gdb ghostscript gjs highway libelf libgudev libheif libjxl libmng libnsgif libunwind libxpm luajit nspr poppler python python-cairo python-gobject qoi-headers-git" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
