...
BASICSTUFF="base-devel binutils gzip tar"
#COMPILERS="gcc"
...
rm -R -f ./$APP.AppDir/.junest/.cache/*
...
mv ./*AppImage ./"$(cat ./$APP.AppDir/*.desktop | grep 'Name=' | head -1 | cut -c 6- | sed 's/ /-/g')"_GIT_$(echo "$VERSIONAUR")-archimage2.1-3-x86_64.AppImage
